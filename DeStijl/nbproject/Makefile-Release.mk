...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/destijl: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/destijl ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/715c31f5/main.o: ../destijl_init/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/715c31f5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/715c31f5/main.o ../destijl_init/main.cpp

${OBJECTDIR}/_ext/236f4aca/functions.o: ../destijl_init/src/functions.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/236f4aca
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/236f4aca/functions.o ../destijl_init/src/functions.cpp

${OBJECTDIR}/_ext/511e4115/image.o: ../src/image.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/image.o ../src/image.cpp

${OBJECTDIR}/_ext/511e4115/message.o: ../src/message.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/message.o ../src/message.cpp

${OBJECTDIR}/_ext/511e4115/monitor.o: ../src/monitor.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/monitor.o ../src/monitor.cpp

${OBJECTDIR}/_ext/511e4115/robot.o: ../src/robot.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/robot.o ../src/robot.cpp
